    ...
    <div class="row justify-content-center">
        <div class="col-8">
            ...
            <div class="row my-3 justify-content-between">
                <h2 class="my-3 col-8 p-0" style="color: #3A85D3;"> Edit What's New</h2>
            ...
            <form id="form" action="/whatsnew/update/<?= esc($whatsnew['slug']) ?>" method="post" enctype="multipart/form-data" class="mb-4">
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" name="nama" class="form-control <?= isset($errors['nama']) ? 'is-invalid' : '' ?>" value="<?= esc(old('nama', $whatsnew['nama'] ?? '')) ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control <?= !empty($errors['versi']) ? 'is-invalid' : '' ?>" id="versi" name="versi" autofocus value="<?= esc(old('versi', $whatsnew['versi'] ?? '')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="category" id="category1" value="internal" <?= old('category', $whatsnew['category'] ?? '') == 'internal' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="category1">Internal</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="category" id="category2" value="eksternal" <?= old('category', $whatsnew['category'] ?? '') == 'eksternal' ? 'checked' : '' ?>>
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        <input type="date" class="form-control <?= !empty($errors['tanggal']) ? 'is-invalid' : '' ?>" id="tanggal" name="tanggal" autofocus value="<?= esc(old('tanggal', $whatsnew['tanggal'] ?? '')); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10 h-100 w-100">
                        <textarea id="shortDesc" name="short_desc" class="form-control <?= !empty($errors['shortDesc']) ? 'is-invalid' : '' ?>" rows="4"><?= esc(old('shortDesc', $whatsnew['short_desc'] ?? '')) ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col h-100">
                        <textarea id="desc" name="full_desc" class="form-control <?= !empty($errors['desc']) ? 'is-invalid' : '' ?>" rows="10"><?= esc(old('desc', $whatsnew['full_desc'] ?? '')) ?></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col d-flex align-items-center">
                        <input type="text" class="form-control <?= !empty($errors['link']) ? 'is-invalid' : '' ?>" id="link" name="user_manual_link" autofocus value="<?= esc(old('link', $whatsnew['user_manual_link'] ?? '')); ?>">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="d-flex ">
                        ...
                        <div class="col" style="max-width: fit-content;">
                            <button type="submit" class="btn " style="background-color: #3A85D3; color:white;"><b>Update</b></button>
                        </div>
                    </div>
                </div>
            </form>
